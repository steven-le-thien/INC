...
python msa.py --in-fasta "/media/sf_constraint_inc/data/100_seq/R0/rose.aln.true.fasta" --out "/media/sf_constraint_inc/data/100_seq/R0/logDet.dist" --os "ubuntu" # --os "osx"
